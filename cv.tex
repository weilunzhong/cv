...
\mobile{+359 877 164 682}                     % optional, remove / comment the line if not wanted
...
\cventry{2016--current}{Systems Consultant}{International Livestock Research Institute}{}{}{Technical management of institutional repository for research outputs\newline{}
  \begin{itemize}
  \item Maintain and deploy source code customizations of the \href{https://cgspace.cgiar.org}{CGSpace} application
  \item Manage Linux server and software stack for development and production instances of the application
  \item Communicate with content submitters and editors about quality and scope of metadata
  \item Inform stakeholders on developments and upcoming features in the upstream DSpace open-source software project
  \item Work with partners on integration and advise on best practices
  \end{itemize}}
\cventry{2011--2016}{Systems Analyst}{International Livestock Research Institute}{Nairobi, Kenya}{}{Oversee research-computing infrastructure and support scientists\newline{}
  \begin{itemize}
  \item Automate role-based infrastructure deployment and configuration management using Ansible
  ...
  \item Maintain and deploy source code customizations of the \href{https://cgspace.cgiar.org}{CGIAR DSpace} institutional repository
  \item Install and configure bioinformatics applications like BLAST+, QIIME, structure, and R
  \item Deploy field data collection system using Android and ODK Collect/Aggregate
  \item Give introduction to Linux courses and hold regular user group meetings
  \end{itemize}}
...
\cvitem{Proficient}{vim, KVM, git, bash, regular expressions, CSS, Apache httpd, mod\_rewrite, nginx}
\cvitem{Intermediate}{MySQL, PostgreSQL, PHP, Apache Tomcat, gerrit, TLS, Jinja2, Python}
...
\cvitemwithcomment{Bulgarian}{Beginner}{Written and spoken}

\section{Interests}
\cvitem{Android}{Porting Android to new devices}
\cvitem{Open-source}{Contributing to open-source software projects}
\cvitem{Community}{\href{https://nairobilug.or.ke}{Nairobi GNU/Linux Users Group}}
\cvitem{Blogging}{\href{https://englishbulgaria.net}{englishbulgaria.net}, \href{https://alaninkenya.org}{alaninkenya.org}, \href{https://mjanja.ch}{mjanja.ch}}
\cvitem{GNU/Linux}{Arch Linux, CentOS, Debian, Fedora, Gentoo, Ubuntu}
\cvitem{The Universe}{The Sloan Great Wall, The Huge-Large Quasar Group, 42}
