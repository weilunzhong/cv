...
\cventry{Sep 2018 - now}{Acting Product Manager}{Klarna}{Stockholm}{Sweden}{Product management for data provisioning platform\newline{}
  \begin{itemize}
  \item Participate in setting the product vision for Klarna\rq s new data processing platform
  ...
  \end{itemize}}
\cventry{Jan 2018 - now}{Software Engineer}{Klarna}{Stockholm}{Sweden}{Data Provisioning for Klarna\rq s internal risk assessment\newline{}
  \begin{itemize}
  \item Develop batch data transformation in Hive and HLTP
  \item Develop Kafka processors for realtime data aggregation
  \end{itemize}}
\cventry{Aug 2015 - Dec 2017}{Data Engineer}{Vionlabs}{Stockholm}{Sweden}{Development of analytic platform for Streaming service that were adopted by industry leader\newline{}
  \begin{itemize}
